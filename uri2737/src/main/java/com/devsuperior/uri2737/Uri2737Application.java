...
public class Uri2737Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		List<LawyerMinProjection> searchRaiz = repository.sqlSearch();
		System.out.println("\n");
		List<LawyerMinDTO> listDTO = searchRaiz.stream().map(x -> new LawyerMinDTO(x)).collect(Collectors.toList());
